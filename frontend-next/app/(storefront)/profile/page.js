 ...
 * 
 * Adapts the original ProfilePage.jsx. Allows user to modify Name and Phone Number.
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={submitting}
              className={`bg-[#4c3e25] text-white px-6 py-2 rounded-lg font-semibold hover:opacity-90 transition-colors ${

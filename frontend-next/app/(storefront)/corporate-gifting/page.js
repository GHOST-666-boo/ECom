...
/**
 * CorporateGiftingPage Component (Next.js adapted)
 * 
 * Corporate gifting information and enquiry submittal form.
 */
      ...
      >
        <div className="max-w-screen-lg mx-auto text-center">
          ...
          <a
            ...
            className="inline-flex items-center gap-3 text-lg md:text-xl transition-opacity duration-300 hover:opacity-85"
            style={{ color: '#cfc5bc', fontFamily: 'Manrope, sans-serif' }}
          >
